    ...
    sections: [
        {
            name: 'Search',
            items: [
                { title: 'Google', url: 'https://google.hk', icon: 'google.png', description: 'Search engine' }, // URL modified
    ...
    sections: [
        {
            name: 'Search',
            items: [
                { title: 'Google', url: 'https://google.hk', icon: 'google.png', description: 'Search engine' }, // Modified
